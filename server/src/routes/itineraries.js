...
router.post('/generate', requireAuth, async (req, res) => {
    ...
    try {
        ...
        const aggregatePrefs = aggregatePreferences(trip.members)
        ...
        const { itinerary, provider } = await generateTripItinerary(tripDetails, aggregatePrefs)
        const validation = validateItineraryStructure(itinerary, tripDetails, aggregatePrefs)
        if (!validation.valid) {
