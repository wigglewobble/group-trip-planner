...
const PreferenceForm = () => {
  ...
  const validate = () => {
    ...
    if (!form.energyLevel) return 'Select your energy level'
    if (!form.travelStyle) return 'Select your travel style'
    return null
  }
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <button
        ...
        className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 mb-6 flex items-center gap-1 transition-colors"
      >
        ← Back to trip
      </button>

      <div className="mb-6">
        <h1 className="text-xl font-medium text-gray-900 dark:text-white">Your preferences</h1>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <button
          type="submit"
          disabled={loading}
          className="bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-sm font-medium py-3 rounded-lg hover:bg-gray-700 dark:hover:bg-gray-300 transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
        >
